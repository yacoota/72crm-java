...
import com.kakarote.crm9.common.config.PathKitExt;
...
public class RedisPlugin implements IPlugin {
    ...
    public boolean start() {
        ...
        JSONObject readJSONObject= JSONUtil.readJSONObject(new File(PathKitExt.getRoot1ClassPath() + "/config/redis.json"), Charset.defaultCharset());
